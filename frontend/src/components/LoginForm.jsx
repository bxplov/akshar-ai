...
export const LoginForm = ({ onSwitchToRegister, onGoHome }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden z-10">
      {/* Warm ambient glow */}
      <div className="absolute top-[10%] right-[10%] w-[400px] h-[400px] bg-[rgba(252,224,123,0.08)] rounded-full blur-[100px] pointer-events-none animate-breathe" />
      <div className="absolute bottom-[10%] left-[10%] w-[350px] h-[350px] bg-[rgba(212,168,67,0.05)] rounded-full blur-[100px] pointer-events-none animate-breathe" style={{ animationDelay: '3s' }} />
        ...
        <div className="w-full max-w-[420px] animate-float-in">
          ...
          >
            ...
            <div className="text-center mb-8">
              <h1 className="text-charcoal text-3xl font-serif tracking-tight" id="login-heading">
                Welcome back
              </h1>
              <p className="text-stone-500 text-base mt-3 font-sans leading-relaxed">
                Sign in to your Akshar AI studio
              </p>
            </div>
